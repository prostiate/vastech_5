...
class other_tax extends Model
{
    ...
    {
        return $this->hasMany('App\purchase_delivery_item', 'tax_id');
    }

    public function purchase_invoice_item()
    {
        return $this->hasMany('App\purchase_invoice_item', 'tax_id');
    }

    public function purchase_order_item()
    {
        return $this->hasMany('App\purchase_order_item', 'tax_id');
    }

    public function purchase_quote_item()
    {
        return $this->hasMany('App\purchase_quote_item', 'tax_id');
    }
    ...
    {
        return $this->hasMany('App\sale_delivery_item', 'tax_id');
    }

    public function sale_invoice_item()
    {
        return $this->hasMany('App\sale_invoice_item', 'tax_id');
    }

    public function sale_order_item()
    {
        return $this->hasMany('App\sale_order_item', 'tax_id');
    }

    public function sale_quote_item()
    {
        return $this->hasMany('App\sale_quote_item', 'tax_id');
    }
    ...
    {
        return $this->hasMany('App\cashbank_item', 'tax_id');
    }

    public function coa()
    {
        return $this->hasMany('App\coa', 'tax_id');
    }
}
