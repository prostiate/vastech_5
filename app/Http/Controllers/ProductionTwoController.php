...
class ProductionTwoController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(production_two::with('contact', 'status', 'warehouse')->get())
                ->make(true);
        }

        return view('admin.products.production_two.station_one.index');
    }
    ...
    public function create()
    {
        ...
        $number             = production_two::latest()->first();
        ...
        return view('admin.products.production_two.station_one.create', compact(['products', 'trans_no', 'today', 'units', 'warehouses', 'contacts']));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach($product as $i => $p){
                $item[$i]                       = new production_two_item([
                    'product_id'                => $request->product[$i],
                    'qty'                       => $request->qty[$i],
                ]);
                $header->production_two_item()->save($item[$i]);
            }
    ...
    {
        $pro        = production_two::find($id);
        $pro_item   = production_two_item::where('production_two_id', $id)->get();
        return view('admin.products.production_two.station_one.show', compact(['pro', 'pro_item']));
    }
