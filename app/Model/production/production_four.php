...
class production_four extends Model implements Auditable
{
    ...
    public function production_four_item()
    {
        return $this->hasMany('App\Model\production\production_four_item');
    }
}
