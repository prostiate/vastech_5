...
class production_two extends Model implements Auditable
{
    ...
    public function production_two_item()
    {
        return $this->hasMany('App\Model\production\production_two_item');
    }
}
