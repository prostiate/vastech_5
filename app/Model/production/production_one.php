...
class production_one extends Model implements Auditable
{
    ...
    {
        return $this->hasMany('App\Model\production\production_one_item');
    }

    public function production_one_cost()
    {
        return $this->hasMany('App\Model\production\production_one_cost');
    }
}
