            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/sales_delivery/'.$pi->selected_sd_id) }}">
                                        <h5> Sales Delivery #{{$pi->transaction_no_sd}}</h5>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 text-center">
                        <div class="form-group">
                            <a href="{{ url('/sales_delivery') }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/sales/invoices/updateFormFromDelivery.js?v=5-20200305-1546') }}" charset="utf-8"></script>
