...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="column-50">
                <div class="card card-costumer">
                    <a>No. Delivery : @if($pp->selected_pd_id) {{$pp->purchase_delivery->number}} @else {{$pp->vendor_ref_no}} @endif</a><br>
                    <a>Tempo : {{$pp->due_date}}
                </div>
            </div>
            <div class="column-50">
                <div class="card" style="text-align: right;">
                    <a>Bekasi, <?php echo date_format($pp->transaction_date,"d F y"); ?></a>
                </div>
            </div>
        </div>
