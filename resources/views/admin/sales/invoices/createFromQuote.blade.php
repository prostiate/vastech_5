            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/sales_quote/'.$po->id) }}">
                                        <h5> Sales Quote #{{$po->number}}</h5>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" value="{{$item->unit_price}}" type="text" class="unit_price_display form-control" name="unit_price_display[]" required>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/sales_quote/'.$po->id) }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/sales/invoices/createFormFromQuote.js')}}" charset="utf-8"></script>
