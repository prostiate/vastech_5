...
@push('scripts')
<script src="{{ asset('js/sales/invoices/dataTable.js?v=5-20200211-1624') }}" charset="utf-8"></script>
<script src="{{ asset('js/sales/invoices/chartdiindex.js?v=5-20200211-1624') }}" charset="utf-8"></script>
@endpush