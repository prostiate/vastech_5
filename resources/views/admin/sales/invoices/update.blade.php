...
<script type="text/javascript" src="{{asset('js/add_field.js')}}" charset="utf-8"></script>
<script type="text/javascript" src="{{asset('js/render_select2.js')}}" charset="utf-8"></script>
<script type="text/javascript" src="{{asset('js/render_datepicker.js')}}" charset="utf-8"></script>
@endpush