...
<script type="text/javascript" src="{{asset('js/add_field.js?v=5-03022020') }}" charset="utf-8"></script>
<script type="text/javascript" src="{{asset('js/render_select2.js?v=5-03022020') }}" charset="utf-8"></script>
<script type="text/javascript" src="{{asset('js/render_datepicker.js?v=5-03022020') }}" charset="utf-8"></script>
@endpush