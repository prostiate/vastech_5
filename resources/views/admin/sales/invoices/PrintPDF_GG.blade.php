        ...
        <div class="row">
            <div class="column-50">
                <div class="card card-costumer align-mid">
                    <h2 class="align-mid"><b> WORKSHOP GG </b></h2>
            ...
            <div class="column-50">
                <div class="card card-costumer">
                    <table class="table-none">
                        <tr>
                            <td> Kepada </td>
                            <td> : <strong>CV. GELORA GEMILANG</strong> </td>
                        </tr>
                        <tr>
                            <td> Alamat </td>
                            <td> : Jl Kalimalang Raya 68 B Bekasi 17145 </td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <table class="table-data">
            ...
            <tbody class="table-body">
                ...
                <tr>
                    ...
                    <td>{{$a->unit->name}}</td>
                    <td> Rp </td>
                    <td style="text-align: right;"> @number($a->cost_unit_price) <span></td>
                    <td> Rp </td>
                    <td style="text-align: right;"> @number($a->cost_amount) <span></td>
                    <?php $number++;
                    $total += $a->cost_amount;
                    $qty += $a->qty ?>
                </tr>
