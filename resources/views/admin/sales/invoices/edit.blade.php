                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control select_contact contact_id" name="vendor_name">
                                        <option>{{$pi->contact->display_name}}</option>
                                    </select>
                                    ...
                                    <input class="tampungan_contact_id" name="vendor_name2" value="{{$pi->contact_id}}" hidden>
                                    <input class="tampungan_contact_term" value="{{$pi->term_id}}" hidden>
                                    <input class="tampungan_email" value="{{$pi->email}}" hidden>
                                    <input class="hidden_contact_id" value="{{$pi->contact_id}}" hidden>
                                    <input class="hidden_shipping_address" value="{{$pi->address}}" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control selectwarehouse" name="warehouse">
                                        ...
                                        <option value="{{$a->id}}" @if($a->id == $pi->warehouse_id) selected @endif>
                                            {{$a->name}}
                                        </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$pi->email}}" type="email" class="form-control email_text" name="email">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea rows="4" class="form-control address" name="vendor_address">{{$pi->address}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="tampungan_product_qty" value="{{$item->qty}}" hidden>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input value="{{$item->qty}}" onClick="this.select();" type="text" class="qty form-control" value='1' name='qty[]'>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <select class="selectunit form-control units" name="units[]" aria-placeholder="Select Product">
                                                @foreach($units as $a)
                                                <option value="{{$a->id}}" @if($a->id == $pi->unit_id_id) selected @endif>
                                                    {{$a->name}}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <td>
                                        <input value="{{$item->unit_price}}" onClick="this.select();" type="text" class="unit_price_display form-control" name="unit_price_display[]" required  required @if($item->product->is_lock_sales == 1) readonly @endif>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <select class="taxes form-control selecttax" name="tax[]">
                                                @foreach($taxes as $a)
                                                <option value="{{$a->id}}" rate="{{$a->rate}}" @if($a->id == $item->tax_id) selected @endif>
                                                    {{$a->name}}
                                                </option>
                                                @endforeach
                                            </select>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                ...
                                <input value="{{$pi->id}}" type="text" name="hidden_id" hidden>
                            </div>
                        </div>
                    </div>
                </form>
...
@push('scripts')
<script src="{{asset('js/sales/invoices/updateForm.js?v=5-20200211-1624') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/invoices/addmoreitem.js?v=5-20200211-1624') }}" charset="utf-8"></script>
