...
@push('scripts')
<script src="{{asset('js/sales/return/createForm.js?v=5-26012020') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/return/addmoreitem.js?v=5-26012020') }}" charset="utf-8"></script>
