...
@push('scripts')
<script src="{{asset('js/sales/return/updateForm.js?v=5-03022020') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/return/addmoreitem.js?v=5-03022020') }}" charset="utf-8"></script>
