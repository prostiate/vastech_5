...
@push('scripts')
<script src="{{asset('js/sales/return/updateForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/return/addmoreitem.js?v=5-20200206-1313') }}" charset="utf-8"></script>
