            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/sales_invoice/'.$header->selected_si_id) }}">
                                        <h5> Sales Invoice #{{$header->transaction_no_si}}</h5>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive my-5">
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <input type="text" name="invoice_item[]" value="{{$item->sale_invoice_item_id}}" hidden>
                                <tr>
                                    <td>
                                        <div class="form-group">
                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <?php
                                    $invoice_amount         = $header->sale_invoice->grandtotal;
                                    if ($other_return == 0) {
                                        $balancedue_amount  = $header->sale_invoice->grandtotal;
                                    } else {
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/sales_return/'.$header->id) }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/sales/return/updateForm.js?v=5-20200302-1755') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/return/addmoreitem.js?v=5-20200302-1755') }}" charset="utf-8"></script>
