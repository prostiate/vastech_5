...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3><b>Create Sales Delivery</b></h3>
            </div>
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" r_val="{{$product->qty_remaining}}" value="{{$product->qty_remaining}}" type="number" class="qty form-control" name='qty[]'>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/sales_order/'.$po->id) }}" class="btn btn-dark">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{ asset('js/sales/delivery/createForm.js?v=5-20200217-1409') }}" charset="utf-8"></script>
