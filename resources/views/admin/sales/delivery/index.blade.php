...
@push('scripts')
<script src="{{asset('js/sales/delivery/dataTable.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{ asset('js/sales/delivery/chartdiindex.js?v=5-20200319-0916') }}" charset="utf-8"></script>
@endpush