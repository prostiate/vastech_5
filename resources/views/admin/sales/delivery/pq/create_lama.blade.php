                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/purchases_order/'.$po->selected_po_id) }}">
                                        <h5>Purchase Order #{{$po->transaction_no}}</h5>
                                    </a>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input r_val="{{$product->qty_remaining}}" value="{{$product->qty_remaining}}" type="text" class="qty form-control" name='qty[]'>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                ...
                                <input value="{{$po->selected_po_id}}" type="hidden" name="hidden_id">
                            </div>
                        </div>
                    </div>
                </form>
