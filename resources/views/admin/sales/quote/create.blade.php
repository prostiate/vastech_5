...
@push('scripts')
<script src="{{asset('js/sales/quote/createForm.js?v=5-26012020') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/quote/addmoreitem.js?v=5-26012020') }}" charset="utf-8"></script>
