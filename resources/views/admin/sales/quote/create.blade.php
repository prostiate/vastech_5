                ...
                <form method="post" id="formCreate" class="form-horizontal">
                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <input class="tampungan_shipping_address" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <h4>
                        ...
                        <div class="col-md-3 center-margin">
                            <div class="form-group">
                                <a href="{{ url('/sales_quote') }}" class="btn btn-danger">Cancel</a>
                                <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/sales/quote/createForm.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/quote/addmoreitem.js?v=5-20200221-1431') }}" charset="utf-8"></script>
