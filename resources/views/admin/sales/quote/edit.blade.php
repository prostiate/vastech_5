                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea rows="4" class="form-control" name="vendor_address">{{$sq->address}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" value="{{$s->unit_price}}" type="text" class="unit_price_display form-control" name="unit_price_display[]" required>
...
@push('scripts')
<script src="{{asset('js/sales/quote/updateForm.js')}}" charset="utf-8"></script>
<script src="{{asset('js/sales/quote/addmoreitem.js')}}" charset="utf-8"></script>
