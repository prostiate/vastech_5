...
@push('scripts')
<script src="{{ asset('js/sales/quote/dataTable.js?v=5-26012020') }}" charset="utf-8"></script>
<script src="{{ asset('js/sales/quote/chartdiindex.js?v=5-26012020') }}" charset="utf-8"></script>
@endpush