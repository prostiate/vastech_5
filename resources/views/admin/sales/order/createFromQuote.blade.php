                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="email" class="form-control email_text" name="email" value="{{$po->email}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" value='{{$item->unit_price}}' type="text" class="unit_price_display form-control" name="unit_price_display[]" required @if($item->product->is_lock_sales == 1) readonly @endif>
...
@push('scripts')
<script src="{{asset('js/sales/order/createFormFromQuote.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/order/addmoreitem.js?v=5-20200315-0243') }}" charset="utf-8"></script>
