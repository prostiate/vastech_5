...
@push('scripts')
<script src="{{asset('js/sales/order/createFormFromQuote.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/sales/order/addmoreitem.js?v=5-20200221-1431') }}" charset="utf-8"></script>
