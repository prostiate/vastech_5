                    ...
                    <table class="table table-striped jambo_table bulk_action" id="dataTable" style="width:100%">
                        <thead>
                            <tr class="headings">
                                ...
                                <!--<th class="column-title">Deposit</th>-->
...
@push('scripts')
<script src="{{ asset('js/sales/order/dataTable.js?v=5-20200217-1409') }}" charset="utf-8"></script>
<script src="{{ asset('js/sales/order/chartdiindex.js?v=5-20200217-1409') }}" charset="utf-8"></script>
@endpush