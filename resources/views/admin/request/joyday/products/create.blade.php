...
@push('scripts')
<script src="{{asset('js/request/joyday/products/addmoreitem.js')}}" charset="utf-8"></script>
<script src="{{asset('js/request/joyday/products/createForm.js')}}" charset="utf-8"></script>
