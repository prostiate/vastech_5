...
@push('scripts')
<script src="{{asset('js/request/joyday/products/addmoreitem.js?v=5-27012020') }}" charset="utf-8"></script>
<script src="{{asset('js/request/joyday/products/createForm.js?v=5-27012020') }}" charset="utf-8"></script>
