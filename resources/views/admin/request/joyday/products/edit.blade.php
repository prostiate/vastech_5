...
@push('scripts')
<script src="{{asset('js/products/products/addmoreitem.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/products/products/updateForm.js?v=5-20200221-1431') }}" charset="utf-8"></script>
