...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/invoices/updateFormFromOrder.js?v=5-26012020') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/invoices/addmoreitemFromOrder.js?v=5-26012020') }}" charset="utf-8"></script>
