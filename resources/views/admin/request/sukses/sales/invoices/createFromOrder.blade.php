...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/invoices/createFormFromOrder.js?v=5-20200302-1755') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/invoices/addmoreitemFromOrder.js?v=5-20200302-1755') }}" charset="utf-8"></script>
