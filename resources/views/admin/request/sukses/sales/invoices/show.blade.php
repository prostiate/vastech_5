                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select id="template_type" class="form-control">
                                                                ...
                                                                @elseif($pi->user->company_id == 2)
                                                                    ...
                                                                    <option value="211">Template Sukses (Surat Jalan)</option>
                                                                    <option value="22" selected>Template Gelora</option>
                                                                    <option value="221">Template Gelora (Surat Jalan)</option>
                                                                    <option value="23">Template Workshop FAS</option>
                                                                    <option value="231">Template Workshop FAS (Surat Jalan)</option>
                                                                @endif
                                                            </select>
                                                        </div>
                                                    </div>
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <a>Rp @number($product->cost_unit_price)</a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <a>Rp @number($product->cost_amount)</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 float-right">
                                        <h5 class="total text-right"> Rp @number($pi->costtotal) </h5>
                                        <br>
                                        @if($pi->amount_paid > 0)
...
@push('scripts')
<script src="{{ asset('js/sales/invoices/deleteForm.js?v=5-20200305-1546') }}" charset="utf-8"></script>
<script>
