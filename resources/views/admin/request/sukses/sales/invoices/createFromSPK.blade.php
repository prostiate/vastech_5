...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/invoices/addmoreitem.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/invoices/createFormFromSPK.js?v=5-20200221-1431') }}" charset="utf-8"></script>
