...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/invoices/addmoreitem.js?v=5-03022020') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/invoices/createFormFromSPK.js?v=5-03022020') }}" charset="utf-8"></script>
