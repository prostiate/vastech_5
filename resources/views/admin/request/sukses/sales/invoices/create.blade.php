...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/invoices/createFormRequestSukses.js?v=5-20200217-1409') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/invoices/addmoreitemRequestSukses.js?v=5-20200217-1409') }}" charset="utf-8"></script>
