                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control select_contact_employee contact_id_employee" name="marketting">
                                        @if($po->marketting != null)
                                        <option>{{$po->contact_marketting->display_name}}</option>
                                        @else
                                        <option></option>
                                        @endif
                                    </select>
                                    <input class="selected_contact_id_employee" hidden>
                                    <input class="tampungan_contact_id_employee" value="{{$po->marketting}}" name="marketting2" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input value="{{$poitem->harga_nota}}" onClick="this.select();" type="text" class="unit_price_display2 form-control" required>
                                        <input value="{{$poitem->harga_nota}}" type="text" class="unit_price2" name="harga_nota[]" hidden>
                                    </td>
                                    <td>
                                        <input value="{{$poitem->unit_price}}" onClick="this.select();" type="text" class="unit_price_display form-control" required>
                                        <input value="{{$poitem->unit_price}}" type="text" class="unit_price" name="unit_price[]" hidden>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                    ...
                                    <td>
                                        ...
                                        <input value="{{$poitem->amount}}" type="text" class="amount" name="total_price[]" hidden>
...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/order/updateForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/order/addmoreitem.js?v=5-20200206-1313') }}" charset="utf-8"></script>
