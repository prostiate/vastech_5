...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/order/updateForm.js') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/order/addmoreitem.js')}}" charset="utf-8"></script>
