...
@push('scripts')
<script src="{{asset('js/request/sukses/sales/order/updateForm.js?v=5-20200211-1624') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/sales/order/addmoreitem.js?v=5-20200211-1624') }}" charset="utf-8"></script>
