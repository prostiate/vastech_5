...
@push('scripts')
<script src="{{asset('js/request/sukses/purchases/invoices/createForm.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/request/sukses/purchases/invoices/addmoreitem3.js?v=5-20200221-1431') }}" charset="utf-8"></script>
