            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title" style="width: 350px">Quantity Before Production</th>
                                    <th class="column-title" style="width: 250px">Quantity per {{$wip->product->other_unit->name}}</th>
                            ...
                            <tfoot class="neworderfoot">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5>Rp @number($wip->grandtotal_with_margin)</h5>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/wip/'.$wip->id) }}" class="btn btn-dark">Cancel</a>
                            <!--{{--@if($wip->spk->status == 2)
