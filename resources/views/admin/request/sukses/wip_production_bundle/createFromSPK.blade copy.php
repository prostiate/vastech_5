...
@push('scripts')
<script src="{{ asset('js/request/sukses/wip/counting.js?v=5-03022020') }}" charset="utf-8"></script>
<script src="{{ asset('js/request/sukses/wip/createForm.js?v=5-03022020') }}" charset="utf-8"></script>
