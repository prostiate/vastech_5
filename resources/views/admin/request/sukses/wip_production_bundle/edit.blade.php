...
@push('scripts')
<script src="{{ asset('js/request/sukses/spk/updateForm.js?v=5-26012020') }}" charset="utf-8"></script>
<script src="{{ asset('js/request/sukses/spk/addmoreitem.js?v=5-26012020') }}" charset="utf-8"></script>
