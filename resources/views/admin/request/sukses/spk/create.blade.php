...
@push('scripts')
<script src="{{ asset('js/request/sukses/spk/createForm.js?v=5-20200211-1624') }}" charset="utf-8"></script>
<script src="{{ asset('js/request/sukses/spk/addmoreitem.js?v=5-20200211-1624') }}" charset="utf-8"></script>
