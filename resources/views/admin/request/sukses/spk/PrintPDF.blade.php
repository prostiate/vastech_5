...
<head>
    ...
    <title>Surat Perintah Kerja #{{$pp->number}}</title>
...
<body>
    <div class="container">
        ...
        <table style="width: 100%">
            <thead>
                <tr>
                    <th colspan="4" style="text-align: right;"><strong>SPK #{{$pp->number}}</strong></th>
                ...
                <tr>
                    ...
                    <td style="width: 116px; border-left: 1px solid; border-top: 1px solid;">
                        <p>Delivery Date</p>
                        <br>
                        <p>Surat Perintah Kerja No.<br></p>
                    </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border-left: 1px solid; text-align: center;">{{$a->qty}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="footer"><small><i>Surat Perintah Kerja #{{$pp->number}}</i></small></div>
</body>
