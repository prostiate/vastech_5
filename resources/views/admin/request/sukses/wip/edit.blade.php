                ...
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang("wip.edit.trans_no")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$wip->number}}" type="text" class="form-control" readonly name="trans_no">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang("wip.edit.trans_date")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang("wip.edit.spk")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang("wip.edit.contact")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang("wip.edit.ref_no")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang("wip.edit.warehouse")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="memoForm" style="text-align: left;">@lang("wip.edit.product_name")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang("wip.edit.product_qty")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="memoForm" style="text-align: left;">@lang("wip.edit.note")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea class="form-control" name="desc" rows="4">{{$wip->desc}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="memoForm" style="text-align: left;">@lang("wip.edit.method")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select name="production_method" class="form-control selectcategory production_method">
                                        <option value="0" selected>@lang("wip.edit.product_method.method_1")</option>
                                        <option value="1">@lang("wip.edit.product_method.method_2")</option>
                                    </select>
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="memoForm" style="text-align: left;">@lang("wip.edit.force")</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div id="material_per_product">
                        <div>
                            <a>@lang("wip.edit.footnote.note_1")<strong><span>1</span></strong> @lang("wip.edit.footnote.note_2") <strong>{{$spk_item->product->name}}</strong></a>
                        </div>
                        <br>
                        <div class="table-responsive my-5">
                            <table id="example" class="table table-striped jambo_table bulk_action">
                                <thead>
                                    <tr class="headings">
                                        <th class="column-title" style="width: 350px">@lang("wip.edit.table.col_1")</th>
                                        <th class="column-title" style="width: 250px">@lang("wip.edit.table.col_2")</th>
                                        <th class="column-title" style="width: 150px">@lang("wip.edit.table.col_3")</th>
                                        <th class="column-title" style="width: 300px">@lang("wip.edit.table.col_4")</th>
                                        <th class="column-title" style="width: 300px">@lang("wip.edit.table.col_5")</th>
                                ...
                                <tbody class="neworderbody_per">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="red span_alert_qty_per" hidden><strong>@lang("wip.edit.stock")</strong></span>
                                ...
                                <tfoot class="neworderfoot_per">
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="text-right">
                                            <h5><strong>@lang("wip.edit.margin")</strong>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-right">
                                            <h5><strong>@lang("wip.edit.cogs")</strong></h5>
                                        </td>
                                        <td colspan="2">
                            ...
                            <input type="button" class="btn btn-dark add_per" value="@lang('wip.edit.more')">
                        </div>
                        <br>
                        <div class="col-md-12 text-center">
                            <div class="form-group">
                                <a href="{{ url('/wip/'.$wip->id) }}" class="btn btn-danger">@lang("wip.edit.cancel")</a>
                                <div class="btn-group">
                                    <button id="click_per" type="button" class="btn btn-success">@lang("wip.edit.update")</button>
                    ...
                    <div id="material_all_product" hidden>
                        <div>
                            <a>@lang("wip.edit.footnote.note_1")<strong><span class="text_product_qty">{{$wip->result_qty}}</span></strong> @lang("wip.edit.footnote.note_3") <strong>{{$spk_item->product->name}}</strong></a>
                        </div>
                        <br>
                        <div class="table-responsive my-5">
                            <table id="example" class="table table-striped jambo_table bulk_action">
                                ...
                                <tbody class="neworderbody_all">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="red span_alert_qty_all" hidden><strong>@lang("wip.edit.stock")</strong></span>
                            ...
                            <input type="button" class="btn btn-dark add_all" value="@lang('wip.edit.more')">
                        </div>
                        <br>
                        <div class="col-md-12 text-center">
                            <div class="form-group">
                                <a href="{{ url('/wip/'.$wip->id) }}" class="btn btn-danger">@lang("wip.edit.cancel")</a>
                                <div class="btn-group">
                                    <button id="click_all" type="button" class="btn btn-success">@lang("wip.edit.update")</button>
                                    <input value="{{$wip->id}}" name="hidden_wip_id" hidden>
                                    <input value="{{$wip->selected_spk_id}}" name="spk_id" hidden>
                                    <input value="0" name="production_bundle" hidden>
                                </div>
...
@push('scripts')
<script src="{{ asset('js/request/sukses/wip/material_per_product.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{ asset('js/request/sukses/wip/material_all_product.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{ asset('js/request/sukses/wip/updateForm_per.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{ asset('js/request/sukses/wip/updateForm_all.js?v=5-20200315-0243') }}" charset="utf-8"></script>
