...
<script src="{{ asset('js/request/sukses/wip/updateForm_per.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{ asset('js/request/sukses/wip/updateForm_all.js?v=5-20200312-1327') }}" charset="utf-8"></script>
