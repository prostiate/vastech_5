...
@push('scripts')
<script src="{{ asset('js/purchases/quote/dataTable.js?v=5-20200302-1755') }}" charset="utf-8"></script>
<script src="{{ asset('js/purchases/quote/chartdiindex.js?v=5-20200302-1755') }}" charset="utf-8"></script>
@endpush