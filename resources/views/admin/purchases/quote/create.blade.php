            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <input class="tampungan_billing_address" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea rows="4" class="form-control address" name="vendor_address"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody class="neworderbody">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="unit_price form-control" name="unit_price[]" hidden>
                                    </td>
                                    <td>
                                        <div class="form-group">
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/purchases_quote') }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/purchases/quote/createForm.js?v=5-20200221-1431') }}" charset="utf-8"></script>
