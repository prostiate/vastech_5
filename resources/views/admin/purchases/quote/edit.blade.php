...
@push('scripts')
<script src="{{asset('js/purchases/quote/updateForm.js')}}" charset="utf-8"></script>
<script src="{{asset('js/purchases/quote/addmoreitem.js')}}" charset="utf-8"></script>
...
<script src="{{asset('js/other/duedate_format_pquote.js')}}" charset="utf-8"></script>
@endpush