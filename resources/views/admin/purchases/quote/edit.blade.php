...
@push('scripts')
<script src="{{asset('js/purchases/quote/updateForm.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/quote/addmoreitem.js?v=5-20200315-0243') }}" charset="utf-8"></script>
...
<script src="{{asset('js/other/duedate_format_pquote.js?v=5-20200315-0243') }}" charset="utf-8"></script>
@endpush