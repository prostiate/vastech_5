            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                        ...
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$pq->number}}" type="text" class="form-control" name="trans_no" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control select_contact contact_id" name="vendor_name">
                                        <option>{{$pq->contact->display_name}}</option>
                                    </select>
                                    ...
                                    <input class="tampungan_contact_id" name="vendor_name2" value="{{$pq->contact_id}}" hidden>
                                    <input class="tampungan_contact_term" value="{{$pq->term_id}}" hidden>
                                    <input class="tampungan_email" value="{{$pq->email}}" hidden>
                                    <input class="hidden_contact_id" value="{{$pq->contact_id}}" hidden>
                                    <input class="hidden_billing_address" value="{{$pq->address}}" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text" class="form-control" name="vendor_no" value="{{$pq->vendor_ref_no}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control selectterm term" name="term">
                                        <option></option>
                                        @foreach($terms as $a)
                                        <option value="{{$a->id}}" length="{{$a->length}}" @if($pq->term_id == $a->id) selected @endif>
                                            {{$a->name}}
                                        </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$pq->transaction_date}}" type="text" class="form-control trans_date" name="trans_date" id="datepicker1">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">Email</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="email" class="form-control email_text" name="email" value="{{$pq->email}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$pq->due_date}}" type="text" class="form-control due_date" name="due_date" id="datepicker2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">Vendor Address</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea rows="4" class="form-control address" name="vendor_address">{{$pq->address}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea class="form-control" name="message" rows="4">{{$pq->message}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea class="form-control" name="memo" rows="4">{{$pq->memo}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/purchases_quote/'.$pq->id) }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
                                <button id="click" type="button" class="btn btn-success">Update</button>
                                <input type="hidden" value="{{$pq->id}}" name="hidden_id">
                            </div>
                        </div>
                    </div>
                </form>
...
@push('scripts')
<script src="{{asset('js/purchases/quote/updateForm.js?v=5-20200302-1755') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/quote/addmoreitem.js?v=5-20200302-1755') }}" charset="utf-8"></script>
...
<script src="{{asset('js/other/duedate_format_pquote.js?v=5-20200302-1755') }}" charset="utf-8"></script>
@endpush