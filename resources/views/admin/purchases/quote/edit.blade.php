...
@push('scripts')
<script src="{{asset('js/purchases/quote/updateForm.js?v=5-20200211-1624') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/quote/addmoreitem.js?v=5-20200211-1624') }}" charset="utf-8"></script>
