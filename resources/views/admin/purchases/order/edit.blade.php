                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" value="{{$product->unit_price}}" type="text" class="unit_price_display form-control" name="unit_price_display[]" required @if($product->product->is_lock_purchase == 1) readonly @endif>
...
@push('scripts')
<script src="{{asset('js/purchases/order/updateForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
