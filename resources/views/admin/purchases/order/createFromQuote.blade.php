...
@push('scripts')
<script src="{{asset('js/purchases/order/createFormFromQuote.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/order/addmoreitem.js?v=5-20200319-0916') }}" charset="utf-8"></script>
