...
@push('scripts')
<script src="{{ asset('js/purchases/order/deleteForm.js?v=5-20200305-1546') }}" charset="utf-8"></script>
<script src="{{ asset('js/purchases/order/closeOrderForm.js?v=5-20200305-1546') }}" charset="utf-8"></script>
<script>
