    ...
    <div class="container">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Cash Amount</td>
                    <td colspan="5">: Rp @number($pp->grandtotal)</td>
                </tr>
                <tr>
                    <td>Payment For</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th style="text-align: center; border-top:1px solid #333; background-color: #f8a978;"><strong>Rp @number($pp->grandtotal)</strong></th>
                </tr>
            </tfoot>
        </table>
    </div>
