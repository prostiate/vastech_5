...
@push('scripts')
<script src="{{ asset('js/purchases/payment/updateForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
...
<script src="{{ asset('js/other/addmoreitem_payment.js?v=5-20200206-1313') }}" charset="utf-8"></script>
@endpush