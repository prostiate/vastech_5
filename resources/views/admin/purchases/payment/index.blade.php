...
@push('scripts')
<script src="{{asset('js/purchases/payment/dataTable.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/payment/chartdiindex.js?v=5-20200206-1313') }}" charset="utf-8"></script>
@endpush