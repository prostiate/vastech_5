...
@push('scripts')
<script src="{{asset('js/purchases/payment/dataTable.js?v=5-27012020') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/payment/chartdiindex.js?v=5-27012020') }}" charset="utf-8"></script>
@endpush