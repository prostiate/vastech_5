...
@push('scripts')
<script src="{{ asset('js/purchases/payment/createForm.js?v=5-27012020') }}" charset="utf-8"></script>
...
<script src="{{ asset('js/other/addmoreitem_payment.js?v=5-27012020') }}" charset="utf-8"></script>
@endpush