...
@push('scripts')
<script src="{{asset('js/purchases/return/updateForm.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/return/addmoreitem.js?v=5-20200312-1327') }}" charset="utf-8"></script>
