        ...
        <div class="x_panel">
            <div class="x_title">
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <button class="btn btn-dark dropdown-toggle" type="button" onclick="window.location.href = '#';" data-toggle="modal" data-target=".bs-example-modal-lg">Other Purchase Return
                        </button>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h5 class="modal-title" id="myModalLabel">Purchase Return History</h5>
                                        <h3 class="modal-title" id="myModalLabel"><strong>Purchase Invoice #{{$pi->purchase_invoice->number}}</strong></h3>
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Purchase Return History</a>
                                            </li>
                                        </ul>
                                    </div>
                                                        ...
                                                        <table id="example" class="table table-striped jambo_table bulk_action">
                                                            <thead>
                                                                <tr class="headings">
                                                                    ...
                                                                    <th class="column-title" style="width:250px">Description</th>
                                                            ...
                                                            <tbody class="neworderbody">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a>Purchase Invoice #{{$po->transaction_no_pi}}</a>
                                                                    </td>
                                                                    <td>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h3 class="modal-title" id="myModalLabel"><strong>Purchase Return #{{$pi->number}}</strong></h3>
                                    </div>
                                    <div class="modal-body">
                                        <div class="table-responsive my-5">
                                            <table id="example" class="table table-striped jambo_table bulk_action">
                ...
                <h3><b>Purchase Return #{{$pi->number}}</b></h3>
                <a>Status: </a>
                @if($pi->status == 1)
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/purchases_invoice/'.$pi->selected_pi_id) }}">
                                        <h5> Purchase Invoice #{{$pi->purchase_invoice->number}}</h5>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 float-right">
                                        @if($pi->taxtotal > 0)
                                        <h5 class="text-right"> Rp @number($pi->subtotal) </h5>
                                        <h5 class="text-right"> Rp @number($pi->taxtotal) </h5>
                                        <br>
                                        @endif
                                        <h3 class="text-right"> Rp @number($pi->grandtotal) </h3>
...
@push('scripts')
<script src="{{ asset('js/purchases/return/deleteForm.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script>
    $('#click_print').click(function() {
        var get_type = $('#template_type').find(":selected").val();
        var get_id = document.getElementById("form_id").value;
        if (get_type == '1') {
            window.open('/purchases_return/print/PDF/1/' + get_id, '_blank');
        } else if (get_type == '2') {
            window.open('/purchases_return/print/PDF/2/' + get_id, '_blank');
        } else if (get_type == '3') {
            window.open('/purchases_return/print/PDF/3/' + get_id, '_blank');
        } else if (get_type == '51') {
            window.open('/purchases_return/print/PDF/sukses_surabaya/' + get_id, '_blank');
        } else if (get_type == '21') {
            window.open('/purchases_return/print/PDF/sukses/' + get_id, '_blank');
        } else if (get_type == '22') {
            window.open('/purchases_return/print/PDF/gelora/' + get_id, '_blank');
        } else if (get_type == '23') {
            window.open('/purchases_return/print/PDF/fas/' + get_id, '_blank');
        }
    });
</script>
@endpush