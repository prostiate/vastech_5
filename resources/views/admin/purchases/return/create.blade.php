...
@push('scripts')
<script src="{{asset('js/purchases/return/createForm.js?v=5-20200302-1755') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/return/addmoreitem.js?v=5-20200302-1755') }}" charset="utf-8"></script>
