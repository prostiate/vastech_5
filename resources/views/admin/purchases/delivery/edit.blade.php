...
@push('scripts')
<script src="{{ asset('js/purchases/delivery/updateForm.js?v=5-27012020') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/addmoreitem.js?v=5-27012020') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/zebradatepicker.js?v=5-27012020') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/qty_remaining_delivery.js?v=5-27012020') }}" charset="utf-8"></script>
@endpush