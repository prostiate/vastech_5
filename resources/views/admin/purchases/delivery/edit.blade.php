                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="poi_id[]" value="{{$product->purchase_order_item->id}}">
                                        </div>
                                    </td>
                                    <td>
                    ...
                    <div class="col-md-12 text-center">
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                ...
                                <input value="{{$pd->purchase_order->number}}" type="hidden" name="hidden_id_number">
                                <input value="{{$pd->purchase_order->address}}" type="hidden" name="address">
                                <input value="{{$pd->purchase_order->term_id}}" type="hidden" name="term">
                            </div>
                        </div>
                    </div>
                </form>
...
@push('scripts')
<script src="{{ asset('js/purchases/delivery/updateForm.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/addmoreitem.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/zebradatepicker.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/qty_remaining_delivery.js?v=5-20200315-0243') }}" charset="utf-8"></script>
@endpush