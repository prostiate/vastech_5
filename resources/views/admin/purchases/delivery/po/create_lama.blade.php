...
@push('scripts')
<script src="{{ asset('js/purchases/delivery/createForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
...
<script src="{{ asset('js/other/qty_remaining.js?v=5-20200206-1313') }}" charset="utf-8"></script>
@endpush