                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" class="r_qty_hidden" name="r_qty_hidden[]" value="{{$product->qty}}">
                                    </td>
                                    <td>
                                        <div class="form-group">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                ...
                                <input value="{{$po->id}}" type="text" name="hidden_id" hidden>
                                <input value="{{$po->number}}" type="text" name="hidden_id_number" hidden>
                                <input value="{{$po->address}}" type="text" name="address" hidden>
                                <input value="{{$po->term_id}}" type="text" name="term" hidden>
                            </div>
                        </div>
                    </div>
                </form>
...
@push('scripts')
<script src="{{ asset('js/purchases/delivery/createForm.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/addmoreitem.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/zebradatepicker.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{ asset('js/other/qty_remaining.js?v=5-20200312-1327') }}" charset="utf-8"></script>
@endpush