...
@push('scripts')
<script src="{{ asset('js/purchases/invoices/dataTable.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{ asset('js/purchases/order/chartdiindex.js?v=5-20200312-1327') }}" charset="utf-8"></script>
@endpush