                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" type="text" id="qtyproduct" class="qty form-control" value="1" name='qty[]'>
                                    </td>
                                    <td>
                                        <div class="form-group">
...
@push('scripts')
<script src="{{asset('js/purchases/invoices/createForm.js?v=5-20200211-1624') }}" charset="utf-8"></script>
