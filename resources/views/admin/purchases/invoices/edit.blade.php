                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <input class="hidden_billing_address" value="{{$pi->address}}" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input value="{{$item->qty}}" onClick="this.select();" type="text" id="qtyproduct" class="qty form-control" value="1" name='qty[]'>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                    ...
                                    <td>
                                        <input value="{{$item->unit_price}}" onClick="this.select();" type="text" class="unit_price_display form-control" name="unit_price_display[]" required @if($item->product->is_lock_purchase == 1) readonly @endif>
...
@push('scripts')
<script src="{{asset('js/purchases/invoices/updateForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/purchases/invoices/addmoreitem.js?v=5-20200206-1313') }}" charset="utf-8"></script>
