            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/purchases_delivery/'.$po->id) }}">
                                        <h5> Purchase Delivery #{{$po->transaction_no}}</h5>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            @foreach ($po_item as $product)
                                <tr>
                                    ...
                                    <td>
                                        <input readonly r_val="{{$product->qty}}" value="{{$product->qty}}" type="text" class="qty form-control" name='qty[]'>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 float-right">
                                        ...
                                        <br>
                                        <input class="awe form-control" value="{{$po->payment_paid}}" readonly>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/purchases_delivery/'.$po->id) }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
                            ...
                            <input value="{{$po->selected_po_id}}" type="hidden" name="hidden_id_po">
...
@push('scripts')
<script src="{{asset('js/purchases/invoices/createFormFromDelivery.js?v=5-20200217-1409') }}" charset="utf-8"></script>
