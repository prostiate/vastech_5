            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control selectterm term" name="term">
                                        @foreach($terms as $a)
                                        <option value="{{$a->id}}" length="{{$a->length}}" @if($po->term_id == $a->id ) selected @endif>
                                            {{$a->name}}
                                        </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/purchases_quote/'.$po->id) }}">
                                        <h5> Purchase Quote #{{$po->number}}</h5>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" value="{{$item->unit_price}}" type="text" class="unit_price_display form-control" name="unit_price_display[]" required @if($item->product->is_lock_purchase == 1) readonly @endif>
                                    ...
                                    <td>
                                        ...
                                        <input value="{{$item->amounttax}}" type="hidden" class="amounttax" name="total_price_tax[]">
                                        <input value="{{$item->amountsub}}" type="hidden" class="amountsub" name="total_price_sub[]">
                                        <input value="{{$item->amountgrand}}" type="hidden" class="amountgrand" name="total_price_grand[]">
                                    </td>
                                    <td>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/purchases_quote/'.$po->id) }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/purchases/invoices/createFormFromQuote.js?v=5-20200211-1624') }}" charset="utf-8"></script>
