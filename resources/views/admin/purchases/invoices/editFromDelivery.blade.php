                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <input type="hidden" name="warehouse" value="{{$pi->warehouse_id}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="{{ url('/purchases_delivery/'.$pi->selected_pd_id) }}">
                                        <h5> Purchase Delivery #{{$pi->transaction_no_pd}}</h5>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 float-right">
                                        ...
                                        <br>
                                        <input class="awe form-control" value="{{$pi->payment_paid}}" readonly>
...
@push('scripts')
<script src="{{asset('js/purchases/invoices/updateFormFromDelivery.js?v=5-20200211-1624') }}" charset="utf-8"></script>
