                ...
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            ...
                            <input value="{{$pi->selected_pq_id}}" type="hidden" name="hidden_id_pq">
                            <input value="{{$pi->transaction_no_pq}}" type="hidden" name="hidden_number_pq">
                        </div>
                    </div>
                </form>
            </div>
...
@push('scripts')
<script src="{{asset('js/purchases/invoices/updateFormFromQuote.js?v=5-20200211-1624') }}" charset="utf-8"></script>
