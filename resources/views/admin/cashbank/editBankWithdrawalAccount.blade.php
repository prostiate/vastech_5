...
@push('scripts')
<script src="{{asset('js/cashbank/updateFormBankWithdrawalAccount.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{asset('js/other/addmoreitem_expenses.js?v=5-20200312-1327') }}" charset="utf-8"></script>
