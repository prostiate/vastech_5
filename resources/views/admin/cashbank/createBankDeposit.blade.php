...
@push('scripts')
<script src="{{asset('js/cashbank/addmoreitem_bankdeposit.js')}}" charset="utf-8"></script>
<script src="{{asset('js/cashbank/createFormBankDeposit.js')}}" charset="utf-8"></script>
