...
@push('scripts')
<script src="{{asset('js/cashbank/addmoreitem_bankdeposit.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/cashbank/createFormBankDeposit.js?v=5-20200206-1313') }}" charset="utf-8"></script>
