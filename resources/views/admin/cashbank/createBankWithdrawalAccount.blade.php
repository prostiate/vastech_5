...
@push('scripts')
<script src="{{asset('js/cashbank/addmoreitem_bankwithdrawalaccount.js?v=5-27012020') }}" charset="utf-8"></script>
<script src="{{asset('js/cashbank/createFormBankWithdrawalAccount.js?v=5-27012020') }}" charset="utf-8"></script>
