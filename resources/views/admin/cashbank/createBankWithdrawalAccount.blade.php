                ...
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="table-responsive my-5">
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr class="headings">
                                    <th class="column-title" style="width: 400px">Payment For <a style="color: white;"><strong><u>Account</u></strong></a></th>
...
@push('scripts')
<script src="{{asset('js/cashbank/addmoreitem_bankwithdrawalaccount.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/cashbank/createFormBankWithdrawalAccount.js?v=5-20200319-0916') }}" charset="utf-8"></script>
