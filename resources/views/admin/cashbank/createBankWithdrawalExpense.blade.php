...
<script src="{{asset('js/cashbank/createFormBankWithdrawalExpense.js')}}" charset="utf-8"></script>
<script src="{{asset('js/other/addmoreitem_cashbankwithdrawalexpense.js')}}" charset="utf-8"></script>
