...
<script src="{{asset('js/jquery.formatCurrency-1.4.0/jquery.formatCurrency-1.4.0.js?v=5-20200217-1409') }}" charset="utf-8"></script>
...
<script src="{{asset('js/cashbank/createFormBankWithdrawalFromExpense.js?v=5-20200217-1409') }}" charset="utf-8"></script>
<script src="{{asset('js/other/addmoreitem_cashbankwithdrawalfromexpense.js?v=5-20200217-1409') }}" charset="utf-8"></script>
