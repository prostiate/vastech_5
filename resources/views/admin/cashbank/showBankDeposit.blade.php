                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li>
                        ...
                        <ul role="menu" class="dropdown-menu">
                            ...
                            @endcan
                            @endrole
                            <li><a target="_blank" href="/cashbank/bank_transfer/PDF/{{$caba->id}}">Print & Preview</a></li>
                        </ul>
                    </li>
                </ul>
                <h3>Bank Deposit #{{$caba->number}}</h3>
                <a>Status: </a>
                @if($caba->status == 1)
                ...
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <h5><a href="/chart_of_accounts/{{$caba->deposit_to}}">{{$caba->coa_deposit_to->name}}</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive my-5">
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                ...
                                <tr>
                                    <td>
                                        <a href="/chart_of_accounts/{{$a->receive_from}}">{{$a->coa->name}}</a>
                                    </td>
                                    <td>
                                        <a>{{$a->desc}}</a>
                                    </td>
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            ...
                            @can('Edit')
                            <div class="btn-group">
                                <button class="btn btn-success" type="button" onclick="window.location.href = '/cashbank/bank_deposit/edit/' + {{$caba->id}};">Edit
                                </button>
                            </div>
                            @endcan
                            @endrole
...
@push('scripts')
<script src="{{asset('js/cashbank/deleteFormBankDeposit.js?v=5-20200302-1755') }}" charset="utf-8"></script>
@endpush