...
<script src="{{asset('js/jquery.formatCurrency-1.4.0/jquery.formatCurrency-1.4.0.js?v=5-20200206-1313') }}" charset="utf-8"></script>
...
<script src="{{asset('js/cashbank/updateFormBankWithdrawalFromExpense.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/other/addmoreitem_cashbankwithdrawalfromexpense.js?v=5-20200206-1313') }}" charset="utf-8"></script>
