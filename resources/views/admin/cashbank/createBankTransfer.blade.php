                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody">
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" type="text" class="amount_display form-control" value="0">
                                        <input type="text" class="amount_hidden" name="amount" value="0" hidden>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
@push('scripts')
<script src="{{asset('js/cashbank/addmoreitem_banktransfer.js?v=5-20200211-1624') }}" charset="utf-8"></script>
<script src="{{asset('js/cashbank/createFormBankTransfer.js?v=5-20200211-1624') }}" charset="utf-8"></script>
