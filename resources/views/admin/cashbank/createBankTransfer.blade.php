...
@push('scripts')
<script src="{{asset('js/cashbank/addmoreitem_banktransfer.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/cashbank/createFormBankTransfer.js?v=5-20200319-0916') }}" charset="utf-8"></script>
