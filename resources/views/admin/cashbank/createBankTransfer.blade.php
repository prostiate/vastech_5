...
@push('scripts')
<script src="{{asset('js/cashbank/addmoreitem_banktransfer.js?v=5-20200305-1546') }}" charset="utf-8"></script>
<script src="{{asset('js/cashbank/createFormBankTransfer.js?v=5-20200305-1546') }}" charset="utf-8"></script>
