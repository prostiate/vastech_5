...
<head>
    ...
    <title>Bank Deposit #{{$pp->number}}</title>
...
<body>
    <div class="container">
        ...
        <table style="width: 100%">
            <thead>
                <tr>
                    <th colspan="4" style="text-align: right;"><strong>Deposit #{{$pp->number}}</strong></th>
                ...
                <tr>
                    <td style="width: 116px; border-left: 1px solid; border-top: 1px solid;">
                        <p>Received From</p>
                        <br>
                        <p>Deposit Account<br></p>
                    </td>
                    <td style="border-top: 1px solid;">
                        <p> : {{$pp->contact->display_name}}</p>
                        <br>
                        <p> : {{$pp->coa_deposit_to->name}}<br></p>
                    </td>
                    <td style="width: 116px; border-left: 1px solid; border-top: 1px solid;">
                        <p>Transaction No</p>
                        <br>
    ...
    <div class="footer"><small><i>Bank Deposit #{{$pp->number}}</i></small></div>
</body>
