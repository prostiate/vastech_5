...
<head>
    ...
    <title>Bank Withdrawal #{{$pp->number}}</title>
...
<body>
    <div class="container">
        ...
        <table style="width: 100%">
            <thead>
                <tr>
                    <th colspan="4" style="text-align: right;"><strong>Withdrawal #{{$pp->number}}</strong></th>
                ...
                <tr>
                    <td style="width: 116px; border-left: 1px solid; border-top: 1px solid;">
                        ...
                        <p>Address</p>
                        <br>
                        <p>Withdrawal Acc.<br></p>
                    </td>
                    <td style="border-top: 1px solid;">
                        <p> : {{$pp->contact->display_name}}</p>
                        <br>
                        <p> : {{$address->expense->address}}<br></p>
                        <br>
                        <p> : {{$pp->coa_pay_from->name}}<br></p>
                    </td>
                    <td style="width: 116px; border-left: 1px solid; border-top: 1px solid;">
                        <p>Transaction No</p>
                        <br>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$a->expense->expense_contact->coaPayable->code}}</td>
                    <td style="border-left: 1px solid;">{{$a->expense->expense_contact->coaPayable->name}}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td style="border-top: 1px solid; border-left: 1px solid; text-align: right;">Rp @number($pp->amount)</td>
                </tr>
                <tr>
                    <td colspan="2">{{$pp->memo}}</td>
                    <td style="border-top: 1px solid; border-left: 1px solid;"><strong>TOTAL</strong></td>
                    <th style="border-top: 1px solid; border-left: 1px solid; text-align: right;"><strong>Rp @number($pp->amount)</strong></th>
                </tr>
            </tfoot>
        </table>
    </div>
    <div class="footer"><small><i>Bank Withdrawal #{{$pp->number}}</i></small></div>
</body>
