            ...
            <div class="jumbotron">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" class="form-control form-control-sm" name="amount" value="0" required>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control form-control-sm" name="number" value="{{$number}}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="descForm">Transaction Date </label>
                        <input type="date" class="form-control form-control-sm" name="date" value="{{$today}}"
                            required>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script type="text/javascript" src="{{asset('js/multiply.js?v=5-20200302-1755') }}" charset="utf-8"></script>
<script type="text/javascript" src="{{asset('js/sum.js?v=5-20200302-1755') }}" charset="utf-8"></script>
@endpush