                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input name="end_period" value="{{$end_period}}">
                                <input name="start_period" value="{{$start_period}}">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @endif @break @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="tb_debit_display">{{$debit}}</a>
                                                        <input hidden class="tb_debit" name="tb_debit[]" value="{{$debit}}">
                                                    </td>
                                                    <td>
                                                        <a class="tb_credit_display">{{$credit}}</a>
                                                    ...
                                                    <td>
                                                        <a class="bs_debit_display">{{$debit}}</a>
                                                        <input hidden class="bs_debit" name="bs_debit[]" value="{{$debit}}">
                                                    </td>
                                                    <td>
                                                        <a class="bs_credit_display">{{$credit}}</a>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-right" style="width: 120px">{{$tb_debit}}</th>
                                                <th class="text-right" style="width: 120px">{{$tb_credit}}</th>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input hidden class="in_credit_total" name="in_credit_total"
                                                        value="{{$in_credit}}">
                                                    <input hidden class="balance_debit_total" name="balance_debit_total"
                                                        value="{{$bs_debit}}">
                                                    <input hidden class="balance_credit_total" name="balance_credit_total"
                                                        value="{{$bs_credit}}">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <input  class="net_debit" name="net_debit" value="0">
                                                    <input  class="net_credit" name="net_credit" value="0">
                                            ...
                                            <select type="select" class="form-control selectaccount"
                                                id="tax_payable_acc" name="tax_payable_acc">
                                            ...
                                            --}}
                                            <tr>
                                                <td colspan="2" class="text-left "><strong>Net Profit Loss</strong></td>
                                                <td colspan="2" class="text-right" style="width: 120px">
                                                    Retained earnings account
                                                    <select type="select" class="form-control selectaccount"
                                                        id="retained_earning_acc" name="retained_earning_acc" 
                                                        @if($closing_book->retained_acc)  data-last={{$closing_book->retained_acc}} @else  data-last="0"  @endif>
