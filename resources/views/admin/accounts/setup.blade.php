...
@push('scripts')
<!--<script src="{{ asset('js/accounts/dataTableindex.js?v=5-20200312-1327') }}" charset="utf-8"></script>-->
<script src="{{asset('js/other/zebradatepicker.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{asset('js/accounts/opening_balance/createForm.js?v=5-20200312-1327') }}" charset="utf-8"></script>
