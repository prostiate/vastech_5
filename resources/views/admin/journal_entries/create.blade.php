...
@push('scripts')
<script src="{{asset('js/journal_entry/createForm.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<script src="{{asset('js/journal_entry/addmoreitem_journal_entry.js?v=5-20200312-1327') }}" charset="utf-8"></script>
