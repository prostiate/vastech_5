            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="form-group">
                            <a href="{{ url('/chart_of_accounts') }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/journal_entry/createForm.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{asset('js/journal_entry/addmoreitem_journal_entry.js?v=5-20200315-0243') }}" charset="utf-8"></script>
