...
<script src="{{asset('js/products/stock_adjustment/createForm.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitem.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/category_to_account.js?v=5-20200319-0916') }}" charset="utf-8"></script>
@endpush