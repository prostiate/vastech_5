...
<script src="{{asset('js/products/stock_adjustment/createForm.js?v=5-20200305-1546') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitem.js?v=5-20200305-1546') }}" charset="utf-8"></script>
