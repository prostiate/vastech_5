...
<script src="{{asset('js/products/stock_adjustment/createForm.js')}}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitem.js')}}" charset="utf-8"></script>
