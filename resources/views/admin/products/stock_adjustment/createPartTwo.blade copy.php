                        ...
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <input type="text" name="type" value="{{$adtype}}" @if($adtype==1) class="type1" checked @else class="type2" checked @endif>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <input type="text" name="type" value="{{$warehouses->id}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody class="neworderbody1">
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <h5><span class="span_product_code"></span></h5>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <h5><span class="span_recorded_qty"></span></h5>
                                            <input type="text" class="recorded_qty" name="recorded_qty[]">
                                        </div>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="actual_qty[]" @if($adtype==1) readonly @endif>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="difference_qty[]" @if($adtype==2) readonly @endif>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <h5><span class="span_avg_price"></span></h5>
                                            <input type="text" class="avg_price" name="avg_price[]">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
...
<script src="{{asset('js/products/stock_adjustment/createForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitem.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/category_to_account.js?v=5-20200206-1313') }}" charset="utf-8"></script>
@endpush