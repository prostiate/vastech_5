                ...
                <form method="post" id="formCreate" class="form-horizontal">
                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <input type="text" name="type" value="{{$warehouses->id}}" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive my-5">
                        <table id="example" class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr class="headings">
                                    <th class="column-title" style="width:550px">Product Name</th>
                                    <th class="column-title">Difference Quantity</th>
                            ...
                            <tbody class="neworderbody1">
                                <tr>
                                    ...
                                    <td>
                                        <input onClick="this.select();" value="0" type="number" class="form-control" name="difference_qty[]">
                                    </td>
                                    <td>
...
<script src="{{asset('js/products/stock_adjustment/createFormStockInOut.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitemStockInOut.js?v=5-20200319-0916') }}" charset="utf-8"></script>
