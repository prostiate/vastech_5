...
<script src="{{asset('js/products/stock_adjustment/createFormStockInOut.js')}}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitemStockInOut.js')}}" charset="utf-8"></script>
