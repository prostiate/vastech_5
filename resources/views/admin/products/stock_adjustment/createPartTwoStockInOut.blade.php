...
<script src="{{asset('js/products/stock_adjustment/createFormStockInOut.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitemStockInOut.js?v=5-20200206-1313') }}" charset="utf-8"></script>
