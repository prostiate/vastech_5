...
<script src="{{asset('js/products/stock_adjustment/createFormStockInOut.js?v=5-27012020') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitemStockInOut.js?v=5-27012020') }}" charset="utf-8"></script>
