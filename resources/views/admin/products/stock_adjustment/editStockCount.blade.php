                                ...
                                <tr>
                                    <td>
                                        <select name="product[]" class="form-control selectproduct_normal product_id">
                                                <option></option>
                                                @foreach($warehouse_detail_from as $b)
                                                <option  @if($a->product_id == $b->product_id) selected @endif value="{{$b->product_id}}" code="{{$b->product->code}}" qty="{{$b->qty}}" avgprice="{{$b->product->avg_price}}">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control avg_price_display" value="{{$a->avg_price}}">
                                            <input type="text" class="form-control avg_price" name="avg_price[]" value="{{$a->avg_price}}" hidden>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
...
<script src="{{asset('js/products/stock_adjustment/updateFormStockCount.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/addmoreitemStockCountAtEdit.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/products/stock_adjustment/product_data.js?v=5-20200206-1313') }}" charset="utf-8"></script>
