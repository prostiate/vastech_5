...
@push('scripts')
<script src="{{asset('js/products/production_four/station_four/createForm.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{asset('js/products/production_four/station_four/addmoreitem.js?v=5-20200315-0243') }}" charset="utf-8"></script>
