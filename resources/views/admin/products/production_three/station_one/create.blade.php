...
@push('scripts')
<script src="{{asset('js/products/production_three/station_three/createForm.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/products/production_three/station_three/addmoreitem.js?v=5-20200319-0916') }}" charset="utf-8"></script>
