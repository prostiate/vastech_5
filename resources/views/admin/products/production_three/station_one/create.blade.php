...
@push('scripts')
<script src="{{asset('js/products/production_three/station_three/createForm.js')}}" charset="utf-8"></script>
<script src="{{asset('js/products/production_three/station_three/addmoreitem.js')}}" charset="utf-8"></script>
