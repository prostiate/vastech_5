...
@push('scripts')
<script src="{{ asset('js/products/warehouses/dataTable.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{ asset('js/products/warehouses/chartdiindex.js?v=5-20200315-0243') }}" charset="utf-8"></script>
@endpush