...
@push('scripts')
<script src="{{asset('js/products/warehouse_transfer_list/addmoreitem.js?v=5-26012020') }}" charset="utf-8"></script>
<script src="{{asset('js/products/warehouse_transfer_list/updateForm.js?v=5-26012020') }}" charset="utf-8"></script>
