...
@push('scripts')
<script src="{{asset('js/products/warehouse_transfer_list/addmoreitem.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/products/warehouse_transfer_list/createForm.js?v=5-20200221-1431') }}" charset="utf-8"></script>
