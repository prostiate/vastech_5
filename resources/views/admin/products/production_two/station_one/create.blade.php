...
@push('scripts')
<script src="{{asset('js/products/production_two/station_two/createForm.js?v=5-03022020') }}" charset="utf-8"></script>
<script src="{{asset('js/products/production_two/station_two/addmoreitem.js?v=5-03022020') }}" charset="utf-8"></script>
