...
@push('scripts')
<script src="{{asset('js/products/production_two/station_two/createForm.js')}}" charset="utf-8"></script>
<script src="{{asset('js/products/production_two/station_two/addmoreitem.js')}}" charset="utf-8"></script>
