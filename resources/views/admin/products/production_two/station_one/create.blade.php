            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <a href="{{ url('/production_two') }}" class="btn btn-danger">Cancel</a>
                            <div class="btn-group">
...
@push('scripts')
<script src="{{asset('js/products/production_two/station_two/createForm.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/products/production_two/station_two/addmoreitem.js?v=5-20200221-1431') }}" charset="utf-8"></script>
