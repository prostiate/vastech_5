...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>@lang('product_1.edit.title')</h2>
                ...
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.name')</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$products->name}}" class="form-control" type="text" id="name_product" name="name_product">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.category')</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.code')</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$products->code}}" class="form-control" type="text" id="code_product" name="code_product">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.unit')</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.check_production')</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <div class="">
                                        <label>
                            ...
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.desc')</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.check_discount')</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <div class="">
                                        <label>
                            ...
                            <div class="col-md-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left;">@lang('product_1.edit.price_lock.price_lock')</label>
                                <div class="col-sm-2">
                                    <div class="checkbox">
                                        <label>
                                            <input @if($products->is_lock_sales == 1) checked @endif type="checkbox" class="is_lock_sales" name="is_lock_sales" id="is_lock_sales">@lang('product_1.edit.price_lock.sales')
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="checkbox">
                                        <label>
                                            <input @if($products->is_lock_purchase == 1) checked @endif type="checkbox" class="" name="is_lock_purchase">@lang('product_1.edit.price_lock.purchase')
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="checkbox">
                                        <label>
                                            <input @if($products->is_lock_production == 1) checked @endif type="checkbox" class="" name="is_lock_production">@lang('product_1.edit.price_lock.production')
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#tab_content1" role="tab" id="invoice-tab" data-toggle="tab" aria-expanded="true">@lang('product_1.edit.tab_1.name')</a>
                            </li>
                            <li role="presentation" class=""><a href="#tab_content3" role="tab" id="discount-tab" @if($products->is_discount == 1) data-toggle="tab" @else data-toggle="" @endif aria-expanded="false">@lang('product_1.edit.tab_2.name')</a>
                            </li>
                            <li role="presentation" class=""><a href="#tab_content4" role="tab" id="production-tab" @if($products->is_production_bundle == 1) data-toggle="tab" @else data-toggle="" @endif aria-expanded="false">@lang('product_1.edit.tab_3.name')</a>
                            </li>
                        </ul>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="x_panel">
                                                    <div class="x_title">
                                                        <div class="">
                                                            <label>
                                                                <input type="checkbox" class="js-switch" value="1" name="is_buy" @if($products->is_buy == 1) checked @endif/>@lang('product_1.edit.tab_1.buy_1')
                                                            </label>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="x_content" data-parsley-validate>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="buy_account_product">@lang('product_1.edit.tab_1.buy_2')
                                                            </label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="buy_tax">@lang('product_1.edit.tab_1.buy_3')
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="buy_price">@lang('product_1.edit.tab_1.buy_4')
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="x_panel">
                                                    <div class="x_title">
                                                        <div class="">
                                                            <label>
                                                                <input type="checkbox" class="js-switch" value="1" name="is_sell" @if($products->is_sell == 1) checked @endif/>@lang('product_1.edit.tab_1.sell_1')
                                                            </label>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="x_content" data-parsley-validate>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sell_account_product">@lang('product_1.edit.tab_1.sell_2')
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sell_tax">@lang('product_1.edit.tab_1.sell_3')
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sell_price">@lang('product_1.edit.tab_1.sell_4')
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="x_panel">
                                                    <div class="x_title">
                                                        <div class="">
                                                            <label>
                                                                <input type="checkbox" class="js-switch" value="1" name="is_track" @if($products->is_track == 1) checked @endif/>@lang('product_1.edit.tab_1.track_1')
                                                            </label>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="x_content" data-parsley-validate>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sell_account_product">@lang('product_1.edit.tab_1.track_2')
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sell_price">@lang('product_1.edit.tab_1.track_3')
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="x_content">
                                        <div class="table-responsive">
                                            <table class="table table-striped jambo_table bulk_action">
                                                <thead>
                                                    <tr class="headings">
                                                        <th class="column-title">@lang('product_1.edit.tab_2.col_1')</th>
                                                        <th class="column-title">@lang('product_1.edit.tab_2.col_2')</th>
                                                    </tr>
                                                </thead>
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        <div class="table-responsive">
                                            ...
                                            <input type="button" class="btn btn-dark add-item_production" value="@lang('product_1.edit.tab_3.more')">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 text-center">
                        <div class="form-group">
                            <button class="btn btn-primary" type="button" onclick="window.location.href = '/products/{{$products->id}}';">@lang('product_1.create.cancel')</button>
                            <div class="btn-group">
                                <button id="click" type="button" class="btn btn-success">@lang('product_1.create.update')</button>
...
@push('scripts')
<script src="{{asset('js/products/products/addmoreitem_product_bundle.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{asset('js/products/products/addmoreitem_production_bundle.js?v=5-20200315-0243') }}" charset="utf-8"></script>
