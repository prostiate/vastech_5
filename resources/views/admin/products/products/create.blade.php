...
@push('scripts')
<script src="{{asset('js/products/products/addmoreitem_product_bundle.js?v=5-20200217-1409') }}" charset="utf-8"></script>
<script src="{{asset('js/products/products/addmoreitem_production_bundle.js?v=5-20200217-1409') }}" charset="utf-8"></script>
<script src="{{asset('js/products/products/createForm.js?v=5-20200217-1409') }}" charset="utf-8"></script>
