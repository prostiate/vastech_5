...
@push('scripts')
<script src="{{ asset('js/products/products/dataTable.js?v=5-20200217-1409') }}" charset="utf-8"></script>
<script src="{{ asset('js/products/products/chartdiindex.js?v=5-20200217-1409') }}" charset="utf-8"></script>
@endpush