                    ...
                    <div id="demo-form2" class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select disabled name="tax" class="form-control col-md-7 col-xs-12 selecttax">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input disabled value="{{$tax->name}}" type="text" name="name" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input disabled value="{{$tax->rate}}" type="number" name="effective_rate" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="checkbox">
                                    <label>
                                        <input disabled type="checkbox" class="flat" name="iCheck" name="witholding" value="1" @if($tax->witholding == 1) checked @else value="0" @endif>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select disabled name="sell_tax_account" class="form-control col-md-7 col-xs-12 selecttax">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select disabled name="buy_tax_account" class="form-control col-md-7 col-xs-12 selecttax">
