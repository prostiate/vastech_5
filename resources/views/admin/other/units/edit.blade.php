            ...
            <div class="x_content">
                <form method="post" id="formCreate" class="form-horizontal">
                    ...
                    <div class="col-md-3 center-margin">
                        <div class="form-group">
                            <button class="btn btn-dark" type="button" onclick="window.location.href = '/other/units/' + {{$unit->id}};">Cancel
                            </button>
                            <div class="btn-group">
                                <button id="click" class="btn btn-success" type="button">Edit unit
                                </button>
...
@push('scripts')
<script src="{{asset('js/otherlists/units/updateForm.js?v=5-20200217-1409') }}" charset="utf-8"></script>
