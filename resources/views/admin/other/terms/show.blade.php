                    ...
                    <div id="demo-form2" class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input disabled value="{{$term->name}}" type="text" name="name" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input disabled value="{{$term->length}}" type="number" name="length" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
