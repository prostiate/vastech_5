...
@push('scripts')
<script src="{{asset('js/construction/offering_letters/addmoreitem.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/construction/offering_letters/createForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
