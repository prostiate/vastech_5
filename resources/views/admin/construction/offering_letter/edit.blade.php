...
@push('scripts')
<script src="{{asset('js/construction/offering_letters/addmoreitem.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{asset('js/construction/offering_letters/updateForm.js?v=5-20200315-0243') }}" charset="utf-8"></script>
