...
@push('scripts')
<script src="{{asset('js/construction/bill_quantities/addmoreitem.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/construction/bill_quantities/updateForm.js?v=5-20200319-0916') }}" charset="utf-8"></script>
