...
@push('scripts')
<script src="{{asset('js/construction/progress/addmoreitem.js?v=5-20200315-0243') }}" charset="utf-8"></script>
<script src="{{asset('js/construction/progress/createForm.js?v=5-20200315-0243') }}" charset="utf-8"></script>
