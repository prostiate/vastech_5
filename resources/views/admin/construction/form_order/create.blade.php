                    ...
                    <div class="form-group">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input value="{{$header_bq->address}}" class="form-control" type="text" name="address">
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
<script src="{{asset('js/construction/form_order/addmoreitem.js?v=5-20200206-1313') }}" charset="utf-8"></script>
<script src="{{asset('js/construction/form_order/createForm.js?v=5-20200206-1313') }}" charset="utf-8"></script>
