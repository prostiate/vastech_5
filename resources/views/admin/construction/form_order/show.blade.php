...
@push('scripts')
<script src="{{asset('js/construction/form_order/deleteForm.js?v=5-20200302-1755') }}" charset="utf-8"></script>
<script src="{{asset('js/construction/form_order/approval.js?v=5-20200302-1755') }}" charset="utf-8"></script>
@endpush
