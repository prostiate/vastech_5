...
@push('scripts')
<script src="{{asset('js/construction/budget_plans/approval.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/construction/budget_plans/deleteForm.js?v=5-20200319-0916') }}" charset="utf-8"></script>
@endpush