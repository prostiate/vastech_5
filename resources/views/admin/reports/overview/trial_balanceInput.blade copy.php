                                                ...
                                                <tr>
                                                    ...
                                                    <?php $move_credit = 0 ?>
                                                        @if($c->id == $cd)
                                                            ...
                                                            @endforeach
                                                            <td class="text-right"><a>@number($opening_debit)</a></td>
                                                            <td class="text-right"><a>@number($opening_credit)</a></td>
