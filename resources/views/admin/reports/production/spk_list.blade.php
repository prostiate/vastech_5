...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Surat Perintah Kerja List</h2>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="/spk/{{$ot->id}}">{{$ot->number}}</a></td>
...
<script>
    ...
    function next() {
        ...
        window.location.href = "/reports/spk_list/start_date=" + date1.value + '&end_date=' + date2.value + '&warehouses=' + warehouses;
    }
    ...
    function nextMoreFilter() {
        ...
        var products = $('#products').val();
        var warehouses = $('#warehouses').val();
        window.location.href = "/reports/spk_list/start_date=" + date3.value + '&end_date=' + date4.value + '&warehouses=' + warehouses;
    }
    ...
    function excel() {
        ...
        var products = $('#products').val();
        var warehouses = $('#warehouses').val();
        window.location.href = "/reports/spk_list/excel/start_date=" + date1.value + '&end_date=' + date2.value + '&warehouses=' + warehouses;
    }
    ...
    function csv() {
        ...
        var products = $('#products').val();
        var warehouses = $('#warehouses').val();
        window.location.href = "/reports/spk_list/csv/start_date=" + date1.value + '&end_date=' + date2.value + '&warehouses=' + warehouses;
    }
    ...
    function pdf() {
        ...
        var products = $('#products').val();
        var warehouses = $('#warehouses').val();
        window.location.href = "/reports/spk_list/pdf/start_date=" + date1.value + '&end_date=' + date2.value + '&warehouses=' + warehouses;
    }
</script>
@endpush