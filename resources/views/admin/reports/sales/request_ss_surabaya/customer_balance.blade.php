        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li><input value="{{$get_this_month}}" type="date" id="datepicker1" class="form-control"></li>
...
<script>
    function next() {
        ...
        window.location.href = "/reports/ss_surabaya/customer_balance/start_date=" + start.value + '&end_date=' + end.value + '&customer=' + contact;
    }
    ...
    function excel() {
        ...
        var end = document.getElementById('datepicker2');
        var contact = $('#filter_by_con').val();
        window.location.href = "/reports/ss_surabaya/customer_balance/excel/start_date=" + start.value + '&end_date=' + end.value + '&customer=' + contact;
    }
    ...
    function csv() {
        ...
        var end = document.getElementById('datepicker2');
        var contact = $('#filter_by_con').val();
        window.location.href = "/reports/ss_surabaya/customer_balance/csv/start_date=" + start.value + '&end_date=' + end.value + '&customer=' + contact;
    }
    ...
    function pdf() {
        ...
        var end = document.getElementById('datepicker2');
        var contact = $('#filter_by_con').val();
        window.open("/reports/ss_surabaya/customer_balance/pdf/start_date=" + start.value + '&end_date=' + end.value + '&customer=' + contact);
    }
</script>
@endpush