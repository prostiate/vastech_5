...
@push('scripts')
<script src="{{asset('js/expenses/updateFormNotNull.js?v=5-20200221-1431') }}" charset="utf-8"></script>
<script src="{{asset('js/other/addmoreitem_expenses.js?v=5-20200221-1431') }}" charset="utf-8"></script>
