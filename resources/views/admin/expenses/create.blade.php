...
@push('scripts')
<script src="{{asset('js/expenses/createForm.js?v=5-20200319-0916') }}" charset="utf-8"></script>
<script src="{{asset('js/expenses/pay_later.js?v=5-20200319-0916') }}" charset="utf-8"></script>
