                    ...
                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    <div id="demo-form2" class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact_type">Contact Type <span class="required">*</span>
                                            </label>
                                            <div class="col-md-1 col-sm-1 col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" id="contact_type1" name="contact_type1" @if($contact->type_customer == 1) value="{{$contact->type_customer}}" checked @else value="1" @endif> Customer
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-1 col-sm-1 col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" id="contact_type2" name="contact_type2" @if($contact->type_vendor == 1) value="{{$contact->type_vendor}}" checked @else value="1" @endif> Vendor
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-1 col-sm-1 col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" id="contact_type3" name="contact_type3" @if($contact->type_employee == 1) value="{{$contact->type_employee}}" checked @else value="1" @endif> Employee
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-1 col-sm-1 col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" id="contact_type4" name="contact_type4" @if($contact->type_other == 1) value="{{$contact->type_other}}" checked @else value="1" @endif> Others
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <a href="{{ url('/contacts/'.$contact->id) }}" class="btn btn-primary">Cancel</a>
...
@push('scripts')
<script src="{{asset('js/contacts/updateForm.js?v=5-20200302-1755') }}" charset="utf-8"></script>
