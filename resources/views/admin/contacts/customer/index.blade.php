...
<div class="page-title">
    <div class="title_left">
        <h3>@lang("contact.index.title2")</h3>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>@lang("contact.index.list_transaction2")</h2>
...
@push('scripts')
<script src="{{ asset('js/contacts/customer/dataTable.js?v=5-20200312-1327') }}" charset="utf-8"></script>
<!--{{--<script src="{{ asset('js/contacts/all/chartdiindex.js?v=5-20200312-1327') }}" charset="utf-8"></script>--}}-->
@endpush