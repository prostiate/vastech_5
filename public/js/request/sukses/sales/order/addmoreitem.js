...
function inputMasking() {
    ...
    $(".unit_price_display2").inputmask("IDR");
...
function selectContactEmployee() {
    $(".select_contact_employee").select2({
        placeholder: "Select Contact",
        width: "100%",
        //minimumInputLength: 1,
        delay: 250,
        allowClear: true,
        ajax: {
            url: "/sales_order/select_contact_employee",
            dataType: "json",
            data: function(params) {
                return {
                    term: params.term || "",
    ...
    function formatRepoSelection2(repo) {
        $(".selected_contact_id_employee").val(repo.id);
        return repo.text || repo.text;
    }
...
$(document).ready(function() {
    ...
    $(".add").click(function() {
        ...
        tr =
            ...
            "</td>" +
            "<td>" +
            '<input onClick="this.select();" type="text" class="form-control unit_price_display2">' +
            '<input type="text" class="unit_price2" name="harga_nota[]" hidden>' +
            "</td>" +
            "<td>" +
            '<input onClick="this.select();" type="text" class="form-control unit_price_display">' +
    ...
    $(".neworderbody").on(
        ...
        function() {
            var tr = $(this).closest("tr");
            var price = tr.find(".unit_price_display2").val() - 0;
            tr.find(".unit_price2").val(price);
        }
    );
    ...
    $(".contact_id_employee").on("change select2-selecting", function() {
        var id = $(".selected_contact_id_employee").val();
        $(".tampungan_contact_id_employee").val(id);
    });
});
