...
$(document).ready(function() {
    ...
    $(".select_account").on("keyup change select2-selecting", function() {
        var id = $(".selected_sales_revenue").val();
        var id = $(".selected_sales_discount").val();
        $(".tampungan_sales_revenue").val(id);
        $(".tampungan_sales_discount").val(id);
    });
});
